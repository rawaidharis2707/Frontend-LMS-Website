...
function voidTransaction(id) {
    if (!confirm('Are you sure you want to void this transaction? it will remain in records but not count towards totals.')) return;
    ...
    if (index > -1) {
        ...
        transactions[index].audit = transactions[index].audit || {};
        transactions[index].audit.voidedAt = new Date().toISOString();
